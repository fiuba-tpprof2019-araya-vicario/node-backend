...
const router = Router()
router.post('/', createValidations, validateWithExpress, checkIsLoggedWithCredentials('EDIT_TUTOR_REQUESTS'), validate(presentationController.createPresentation))
...
router.put('/:id([0-9]+)?/submit/', getValidations, validateWithExpress, checkIsLoggedWithCredentials('EDIT_TUTOR_REQUESTS'), validate(presentationController.submitPresentation))
