...
router.post('/', createValidations, validateWithExpress, checkIsLoggedWithCredentials('EDIT_REQUIREMENTS'), validate(createRequirement))
router.put('/:id([0-9]+)?/', modifyValidations, validateWithExpress, checkIsLoggedWithCredentials('EDIT_REQUIREMENTS'), validate(putRequirement))
